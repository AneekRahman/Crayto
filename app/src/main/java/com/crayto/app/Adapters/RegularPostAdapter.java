...
import com.crayto.app.Classes.PostButtonBounceInterpolator;
import com.crayto.app.Classes.RegularPost;
import com.crayto.app.HomeFragment;
...
public class RegularPostAdapter extends RecyclerView.Adapter<RegularPostAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView mPostDpImageView, mBufferingSpinner, mHeartImageView, mCommentImageView, mBroadcastImageView;
        private RelativeLayout mMainHolder;
        private LinearLayout mPostInteractionHolder;
        ...
        private void setUpPostClickListeners(){
            ...
            mCommentImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    RegularPost regularPost = postsList.get(getHolderID());
                    if (regularPost != null)
                        mHomeFragment.showComments(mMyUtils.formatNumbers(regularPost.getPostCommentCount()), regularPost.getPostUserDpUrl());
                }
            });
