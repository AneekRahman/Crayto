...
import com.crayto.app.Adapters.RegularPostAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mMainHolder.setPadding(0, mMyUtils.getPixelsFromDp(55, getContext()) + mMyUtils.getStatusBarHeight(getContext()), 0, 0);
    ...
    // Shows the comment layout when a posts comment icon is triggered (Accessed from adapter)
    public void showComments(String commentCount, String postUserDpUrl){

        ((MainActivity)getActivity()).showComments(commentCount, postUserDpUrl);
